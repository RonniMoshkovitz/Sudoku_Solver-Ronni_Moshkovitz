...
{
    // This Exception is an exception for when the given board is illeagal (contredicts the sudoku rules).
    ...
    // This Exception is an exception for when the given board is illeagal due to multiple appearences of the same value in the same house.
    ...
    // This Exception is an exception for when the given board is illeagal due to multiple appearences of the same value in the same row.
    ...
    // This Exception is an exception for when the given board is illeagal due to multiple appearences of the same value in the same column.
    ...
    // This Exception is an exception for when the given board is illeagal due to multiple appearences of the same value in the same box.
